from pycountsik.pycounts import count_words
from pycountsik.plotting import plot_words
from pycountsik.datasets import get_flatland
import matplotlib  
...
def test_regression():
    ...
    assert top_word[0][1] == 2262, "'the' count has changed"